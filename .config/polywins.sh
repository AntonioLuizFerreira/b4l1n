...
# active_bg="#00000000"
active_bg="#1e222a"
active_underline="#ffb300"

inactive_text_color="#757575"
inactive_bg=
# inactive_underline="#757575"
  ...
  while IFS="[ .\.]" read -r wid ws cname cls host title; do
    ...
    *$cls*) continue ;;
    ...
    "icon")
      ...
      libreoffice-calc) w_name='' ;;
      opera) w_name='' ;;
      Xfce4-terminal) w_name='' ;;
      ICE-SSB-deezer) w_name='📻' ;;
      Deezer) w_name='📻' ;;
      qutebrowser) w_name='📻' ;;
      SimpleScreenRecorder) w_name='' ;;
      Blue-recorder) w_name='' ;;
      # firefox) w_name='' ;;
      # Vivaldi-stable) w_name='' ;;
      # Brave-browser) w_name='' ;;
      "(/mnt/storage/browser/Brave-Browser)") w_name='Brave' ;;
      "(/mnt/storage/browser/chromium)") w_name='Chromium' ;;
      Transmission-gtk) w_name='' ;;
      XTerm) w_name='📊' ;;
      Pavucontrol) w_name='' ;;
      smplayer) w_name='' ;;
      vlc) w_name='' ;;
